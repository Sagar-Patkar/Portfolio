                        ...
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <div className="z-10 sm:order-2 sm:col-span-6">
                                ...
                                <p className="mt-2 text-sm leading-normal">
                                    Developed a suite of Web Applications for Royal Sundaram, providing accurate premium information based on user inputs for various insurance types.
                                </p>
                    ...
                    <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <div className="z-10 sm:order-2 sm:col-span-6">
                                ...
                                <p className="mt-2 text-sm leading-normal">
                                    Developed an educational platform with sections for teachers, students, and parents,
                                    enabling students to select subjects, complete skill assessments, and track progress, with
                                    monitoring features for parents and teachers.
                                </p>
                                <ul className="mt-2 flex flex-wrap" aria-label="Technologies used">
                                    <li className="mr-1.5 mt-2">
                                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">
                    ...
                    <li className="mb-12">
                        <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                            ...
                            <div className="z-10 sm:order-2 sm:col-span-6">
                                ...
                                <p className="mt-2 text-sm leading-normal">
                                    Developed an e-commerce website, where user can add products to cart & purchase, whereas admin can add or remove products and update the pricing
                                </p>
                                <ul className="mt-2 flex flex-wrap" aria-label="Technologies used">
                                    <li className="mr-1.5 mt-2">
                                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">
